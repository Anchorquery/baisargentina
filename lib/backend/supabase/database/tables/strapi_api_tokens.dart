...
class StrapiApiTokensTable extends SupabaseTable<StrapiApiTokensRow> {
  @override
  String get tableName => 'strapi_api_tokens';

  @override
  StrapiApiTokensRow createRow(Map<String, dynamic> data) =>
      StrapiApiTokensRow(data);
}

class StrapiApiTokensRow extends SupabaseDataRow {
  StrapiApiTokensRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => StrapiApiTokensTable();
