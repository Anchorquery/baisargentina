...
class ListaTicketsModel extends FlutterFlowModel<ListaTicketsWidget> {
  ...
  // Stores action output result for [Backend Call - API (find reservas admin)] action in ListaTickets widget.
