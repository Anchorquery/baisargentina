...
import 'editar_perfil_comercio_model.dart';
...
class EditarPerfilComercioWidget extends StatefulWidget {
  ...
  State<EditarPerfilComercioWidget> createState() =>
      _EditarPerfilComercioWidgetState();
}

class _EditarPerfilComercioWidgetState extends State<EditarPerfilComercioWidget>
    with TickerProviderStateMixin {
  late EditarPerfilComercioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarPerfilComercioModel());
