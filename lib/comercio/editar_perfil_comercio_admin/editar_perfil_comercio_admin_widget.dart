...
import 'editar_perfil_comercio_admin_model.dart';
export 'editar_perfil_comercio_admin_model.dart';

class EditarPerfilComercioAdminWidget extends StatefulWidget {
  const EditarPerfilComercioAdminWidget({
    super.key,
    this.id,
  });
  ...
  @override
  State<EditarPerfilComercioAdminWidget> createState() =>
      _EditarPerfilComercioAdminWidgetState();
}

class _EditarPerfilComercioAdminWidgetState
    extends State<EditarPerfilComercioAdminWidget>
    with TickerProviderStateMixin {
  late EditarPerfilComercioAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarPerfilComercioAdminModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResulteme = await UserGroup.obtenerPerfilComercioCall.call(
        id: widget!.id,
      ...
      if ((_model.apiResulteme?.succeeded ?? true)) {
        ...
        safeSetState(() {
          _model.categoryValueController?.value = _model.perfil!.category.id;
        });
        safeSetState(() {
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context.goNamed('ListaUsuarioComercios');
                                },
                                child: Icon(
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          'Asegúrate de que tus clientes te encuentren fácilmente. Pega la URL de Google Maps para una ubicación precisa.',
