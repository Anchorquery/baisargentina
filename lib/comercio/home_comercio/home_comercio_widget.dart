...
class _HomeComercioWidgetState extends State<HomeComercioWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResultMeCoomercio = await UserGroup.meCall.call(
        token: currentAuthenticationToken,
      );

      if ((_model.apiResultMeCoomercio?.succeeded ?? true)) {
        _model.data = CommercePerfilStruct.maybeFromMap(getJsonField(
          (_model.apiResultMeCoomercio?.jsonBody ?? ''),
          r'''$.metadata''',
        ));
                                    ...
                                    onTap: () async {
                                      ...
                                      if ((_model.resultScanQr != '-1') &&
                                          (_model.resultScanQr != null &&
                                              _model.resultScanQr != '')) {
                                        _model.apiResultucb = await PlanGroup
                                        ...
                                        _shouldSetState = true;
                                        if ((_model.apiResultucb?.succeeded ??
                                            true)) {
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      'Edita o añade informaciòn sobre tu local.',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                          .override(
