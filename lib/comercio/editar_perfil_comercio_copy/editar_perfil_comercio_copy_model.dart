...
import 'dart:math';
import 'editar_perfil_comercio_copy_widget.dart'
...
class EditarPerfilComercioCopyModel
    extends FlutterFlowModel<EditarPerfilComercioCopyWidget> {
  ...
  // Stores action output result for [Backend Call - API (me )] action in editarPerfilComercioCopy widget.
  ...
  // State field(s) for Carousel widget.
  CarouselSliderControllerroller? carouselController2;
