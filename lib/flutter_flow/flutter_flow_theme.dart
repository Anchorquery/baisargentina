...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF00215B);
  late Color secondary = const Color(0xFFFFFFFF);
  late Color tertiary = const Color(0xFFFF8F14);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF001232);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0xFFCBCACA);
  late Color accent3 = const Color(0xFFC06D13);
  late Color accent4 = const Color(0xFF9C9D9E);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF00215B);
  late Color secondary = const Color(0xFFCBCACA);
  late Color tertiary = const Color(0xFFFF8F14);
  late Color alternate = const Color(0xFFE0E3E7);
  ...
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF001232);
  late Color accent2 = const Color(0xFFCBCACA);
  late Color accent3 = const Color(0xFFC06D13);
  late Color accent4 = const Color(0xFF9C9D9E);
  late Color success = const Color(0xFF249689);
