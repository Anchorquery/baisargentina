...
import 'lista_usuario_comercios_model.dart';
export 'lista_usuario_comercios_model.dart';

class ListaUsuarioComerciosWidget extends StatefulWidget {
  const ListaUsuarioComerciosWidget({super.key});

  @override
  State<ListaUsuarioComerciosWidget> createState() =>
      _ListaUsuarioComerciosWidgetState();
}

class _ListaUsuarioComerciosWidgetState
    extends State<ListaUsuarioComerciosWidget> with TickerProviderStateMixin {
  late ListaUsuarioComerciosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaUsuarioComerciosModel());
