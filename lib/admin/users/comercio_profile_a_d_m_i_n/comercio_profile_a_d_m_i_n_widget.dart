...
import 'comercio_profile_a_d_m_i_n_model.dart';
...
class ComercioProfileADMINWidget extends StatefulWidget {
  ...
  State<ComercioProfileADMINWidget> createState() =>
      _ComercioProfileADMINWidgetState();
}

class _ComercioProfileADMINWidgetState
    extends State<ComercioProfileADMINWidget> {
  late ComercioProfileADMINModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComercioProfileADMINModel());
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(0.0, 20.0, 0.0, 0.0),
                        child: Text(
                          'Eventos realizados en el local',
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    fontFamily: 'Lato',
                                    color: Color(0xFFFF8F14),
