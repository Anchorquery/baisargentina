...
import 'dart:math';
import 'dart:ui';
import 'lista_categoria_deeventos_admin_widget.dart'
...
class ListaCategoriaDeeventosAdminModel
    extends FlutterFlowModel<ListaCategoriaDeeventosAdminWidget> {
  ...
  // Stores action output result for [Backend Call - API (ObtenerCategoriasDescuento)] action in ListaCategoriaDeeventosAdmin widget.
