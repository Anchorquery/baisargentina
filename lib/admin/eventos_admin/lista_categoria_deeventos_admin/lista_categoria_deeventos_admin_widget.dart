...
import 'lista_categoria_deeventos_admin_model.dart';
export 'lista_categoria_deeventos_admin_model.dart';

class ListaCategoriaDeeventosAdminWidget extends StatefulWidget {
  const ListaCategoriaDeeventosAdminWidget({super.key});

  @override
  State<ListaCategoriaDeeventosAdminWidget> createState() =>
      _ListaCategoriaDeeventosAdminWidgetState();
}

class _ListaCategoriaDeeventosAdminWidgetState
    extends State<ListaCategoriaDeeventosAdminWidget>
    with TickerProviderStateMixin {
  late ListaCategoriaDeeventosAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaCategoriaDeeventosAdminModel());
