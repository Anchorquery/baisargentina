...
import 'lista_eventos_admin_model.dart';
export 'lista_eventos_admin_model.dart';

class ListaEventosAdminWidget extends StatefulWidget {
  const ListaEventosAdminWidget({super.key});

  @override
  State<ListaEventosAdminWidget> createState() =>
      _ListaEventosAdminWidgetState();
}

class _ListaEventosAdminWidgetState extends State<ListaEventosAdminWidget>
    with TickerProviderStateMixin {
  late ListaEventosAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaEventosAdminModel());
