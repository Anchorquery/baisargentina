                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FlutterFlowDropDown<int>(
                            controller:
                                _model.comercioSelectorValueController ??=
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (_model.comercioSelectorValue == null) {
                                    await showDialog(
                                      context: context,
                                  ...
                                  if (_model.puedenUsarloValue == null) {
                                    await showDialog(
                                      context: context,
                                      builder: (dialogContext) {
                                        return Dialog(
                                          ...
                                          child: GestureDetector(
                                            ...
                                            child: ModalInformativoWidget(
                                              textMessage:
                                                  'Define quienes pueden usar el cupón. ',
                                              messageButton: 'Cerrar',
                                            ),
                                          ),
                                        );
                                  ...
                                  _model.apiResultpzr = await DiscoinGroup
                                      .editarDescuentoCall
                                      .call(
                                  ...
                                  _shouldSetState = true;
                                  if ((_model.apiResultpzr?.succeeded ??
                                      true)) {
                                    await showDialog(
                                      context: context,
