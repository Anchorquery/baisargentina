...
class ListadoChatsModel extends FlutterFlowModel<ListadoChatsWidget> {
  ...
  // Stores action output result for [Backend Call - API (listar chats)] action in ListadoChats widget.
  ApiCallResponse? apiCargarChats;
  // State field(s) for TextField widget.
  FocusNode? textFieldFocusNode;
  TextEditingController? textController;
  String? Function(BuildContext, String?)? textControllerValidator;
  // Stores action output result for [Backend Call - API (listar chats)] action in Column widget.
