...
import 'planes_copy_model.dart';
export 'planes_copy_model.dart';

class PlanesCopyWidget extends StatefulWidget {
  const PlanesCopyWidget({super.key});

  @override
  State<PlanesCopyWidget> createState() => _PlanesCopyWidgetState();
}

class _PlanesCopyWidgetState extends State<PlanesCopyWidget>
    with TickerProviderStateMixin {
  late PlanesCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlanesCopyModel());
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: Image.asset(
                                  ...
                                  width:
                                      MediaQuery.sizeOf(context).width * 1.066,
                                  height:
                                    ...
                                    builder: (context) {
                                      ...
                                      return SingleChildScrollView(
                                        ...
                                        child: Row(
                                          ...
                                          children:
                                              List.generate(listaplanes.length,
                                                  (listaplanesIndex) {
                                            final listaplanesItem =
                                                listaplanes[listaplanesIndex];
                                            return Align(
