...
import 'editar_perfil_comercio_primer_loguin_model.dart';
export 'editar_perfil_comercio_primer_loguin_model.dart';

class EditarPerfilComercioPrimerLoguinWidget extends StatefulWidget {
  const EditarPerfilComercioPrimerLoguinWidget({super.key});

  @override
  State<EditarPerfilComercioPrimerLoguinWidget> createState() =>
      _EditarPerfilComercioPrimerLoguinWidgetState();
}

class _EditarPerfilComercioPrimerLoguinWidgetState
    extends State<EditarPerfilComercioPrimerLoguinWidget>
    with TickerProviderStateMixin {
  late EditarPerfilComercioPrimerLoguinModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => EditarPerfilComercioPrimerLoguinModel());
