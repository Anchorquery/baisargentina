...
class EditarPerfilUserPrimerLoguinModel
    extends FlutterFlowModel<EditarPerfilUserPrimerLoguinWidget> {
  ...
  // Stores action output result for [Backend Call - API (me )] action in EditarPerfilUserPrimerLoguin widget.
