...
import 'listado_housing_model.dart';
export 'listado_housing_model.dart';

class ListadoHousingWidget extends StatefulWidget {
  const ListadoHousingWidget({super.key});

  @override
  State<ListadoHousingWidget> createState() => _ListadoHousingWidgetState();
}

class _ListadoHousingWidgetState extends State<ListadoHousingWidget> {
  late ListadoHousingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListadoHousingModel());
