...
import 'dart:ui';
import 'listado_housing_widget.dart' show ListadoHousingWidget;
...
class ListadoHousingModel extends FlutterFlowModel<ListadoHousingWidget> {
  ...
  // Stores action output result for [Backend Call - API (Obtener todos los housing)] action in ListadoHousing widget.
  ApiCallResponse? apiResponseHopusing;
  // Stores action output result for [Backend Call - API (Api Get Categories)] action in ListadoHousing widget.
