...
import 'reserva_id_admin_model.dart';
export 'reserva_id_admin_model.dart';

class ReservaIdAdminWidget extends StatefulWidget {
  const ReservaIdAdminWidget({
    super.key,
    required this.uuid,
    bool? isAdmin,
  ...
  @override
  State<ReservaIdAdminWidget> createState() => _ReservaIdAdminWidgetState();
}

class _ReservaIdAdminWidgetState extends State<ReservaIdAdminWidget>
    with TickerProviderStateMixin {
  late ReservaIdAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReservaIdAdminModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResponseFindMeBookingAdmin =
          await ReserveGroup.findOneAdminCall.call(
        token: currentAuthenticationToken,
        uuid: widget!.uuid,
      );

      if ((_model.apiResponseFindMeBookingAdmin?.succeeded ?? true)) {
        _model.data = BookingStruct.maybeFromMap(getJsonField(
          (_model.apiResponseFindMeBookingAdmin?.jsonBody ?? ''),
          r'''$.data''',
        ));
