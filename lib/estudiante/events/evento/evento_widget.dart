                ...
                return Align(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          ClipRRect(
                            ...
                            child: OctoImage(
                              placeholderBuilder: (_) => SizedBox.expand(
                                child: Image(
                                  image:
                                      BlurHashImage(_model.portada!.blurhash),
                                  fit: BoxFit.cover,
                                ),
                              ),
                              image: NetworkImage(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Align(
                                alignment: AlignmentDirectional(0.0, 0.0),
                                child: Text(
                                  _model.data?.type == TypeEvent.free.name
                                      ? 'Gratuito'
                                      : 'Pago',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                    ...
                                    children: [
                                      ...
                                      TextSpan(
                                        text: valueOrDefault<String>(
                                          _model.data?.nameOrganizerNoBais,
                                          'nombre',
                                        ),
                                        style: TextStyle(),
                                      )
                      ...
                      if ((_model.data?.precio != null) &&
                          (_model.data!.precio > 0.0))
                        Align(
                          alignment: AlignmentDirectional(-1.0, 0.0),
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                            ...
                            onPressed: _model.data!.reservado
                                ...
                                : () async {
                                    _model.apiResponseCreateReserve =
                                        await ReserveGroup.createReserveCall
                                            .call(
                                      token: currentAuthenticationToken,
                                      event: widget!.id,
                                    );
