...
import 'dart:ui';
import 'listar_eventos_widget.dart' show ListarEventosWidget;
...
class ListarEventosModel extends FlutterFlowModel<ListarEventosWidget> {
  ...
  // Stores action output result for [Backend Call - API (GetEvents)] action in ListarEventos widget.
  ApiCallResponse? apiResponseEvents;
  // Stores action output result for [Backend Call - API (Api Get Categories)] action in ListarEventos widget.
