...
import 'registro_copy_model.dart';
export 'registro_copy_model.dart';

class RegistroCopyWidget extends StatefulWidget {
  const RegistroCopyWidget({super.key});

  @override
  State<RegistroCopyWidget> createState() => _RegistroCopyWidgetState();
}

class _RegistroCopyWidgetState extends State<RegistroCopyWidget>
    with TickerProviderStateMixin {
  late RegistroCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegistroCopyModel());
