            ...
            child: Column(
              ...
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/RESTABLECER_CONTRASEA_correo_electronico.png',
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 10.0, 0.0, 15.0),
                          child: Text(
                            '¿Olvidaste tu contraseña? No te preocupes. Ingresa tu correo electrónico y te enviaremos un código de recuperación para que puedas acceder nuevamente a tu cuenta en pocos pasos.',
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 5.0, 0.0, 0.0),
                          child: Text(
                            'Ingresa un correo asociado a tu cuenta',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Lato',
