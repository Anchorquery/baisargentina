...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    bAISArgentinaAuthUserSubject.add(
      BAISArgentinaAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<BAISArgentinaAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  BAISArgentinaAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = BAISArgentinaAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    bAISArgentinaAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
BAISArgentinaAuthUser? currentUser;
